# Linked-List-Project
A custom linked-list–based order management system with manual memory management, simulating a multi-station assembly line to manage dynamic customer orders and station queues.
...
# To Run
To run compile and run with arguments in the following order: Stations1.txt Stations2.txt CustomerOrders.txt AssemblyLine.txt 
